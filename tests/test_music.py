...
class testMusic(unittest.TestCase):
    ...
    def test_change_song(self):
        ...
        self.assertEqual(self.music.current_song, self.droopy)
    ...
    def test_prev_song(self):
        ...
        self.assertEqual(self.music.current_song, self.firebugs)
        self.music.prev_song()
        self.assertEqual(self.music.current_song, self.sweden)
...
class TestMusicCollection(unittest.TestCase):
    ...
    def test_fourth_item(self):
        self.assertEqual(self.musicPath[3], self.droopy)

    def test_fifth_item(self):
        self.assertEqual(self.musicPath[4], self.dry_hands)

    def test_sixth_item(self):
        self.assertEqual(self.musicPath[5], self.haggstrom)

    def test_seventh_item(self):
        self.assertEqual(self.musicPath[6], self.mice)

    def test_eighth_item(self):
        self.assertEqual(self.musicPath[7], self.mice_venus)

    def test_ninth_item(self):
        self.assertEqual(self.musicPath[8], self.minecraft)

    def test_tenth_item(self):
        self.assertEqual(self.musicPath[9], self.moog_city)

    def test_eleventh_item(self):
        self.assertEqual(self.musicPath[10], self.wet_hands)

    def test_twelfth_item(self):
        self.assertEqual(self.musicPath[11], self.dog)

    def test_thirteenth_item(self):
        self.assertEqual(self.musicPath[12], self.sweden)
